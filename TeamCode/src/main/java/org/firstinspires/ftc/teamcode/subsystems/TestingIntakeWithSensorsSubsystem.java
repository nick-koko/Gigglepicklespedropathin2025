 ...
 */
@Configurable
public class TestingIntakeWithSensorsSubsystem implements Subsystem {

    public static final TestingIntakeWithSensorsSubsystem INSTANCE = new TestingIntakeWithSensorsSubsystem();
    private TestingIntakeWithSensorsSubsystem() {}
