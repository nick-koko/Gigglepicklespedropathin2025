...
//            new ShotSample(12, 90.0, 14.0, 4450.0, 0.525, -1.5, 134.0, "B", "B right hood-max"),
            ...
            new ShotSample(0, 72.0, 72.0, 3380.0, 0.525, 1., 136.0, "A", "A apex"),
            new ShotSample(1, 36.0, 108.0, 2730.0, 0.22, -0.5, 133.0, "A", "A mid-left"),
            new ShotSample(2, 108.0, 108.0, 3630.0, 0.525, -1., 128.0, "A", "A mid-right hood-max"),
            new ShotSample(3, 72.0, 108.0, 3280.0, 0.44, 0.5, 132.0, "A", "A mid-center"),
            new ShotSample(4, 40.0, 134.0, 2630.0, 0.00, 0.0, 134.0, "A", "A upper-left edge"),
            new ShotSample(5, 50.0, 87.0, 3230.0, 0.525, 1., 136.0, "A", "A left interior hood-max"),
            new ShotSample(6, 72.0, 130.0, 3130.0, 0.44, 0.5, 132.0, "A", "A upper-center"),
            new ShotSample(7, 86.0, 89.0, 3380.0, 0.525, -0.5, 129.0, "A", "A right interior hood-max"),
            new ShotSample(8, 110.0, 130.0, 3765.0, 0.525, -0.5, 135.0, "A", "A upper-right hood-max"),
