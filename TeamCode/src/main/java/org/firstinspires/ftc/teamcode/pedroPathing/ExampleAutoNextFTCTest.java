...
public class ExampleAutoNextFTCTest extends OpMode {
    ...
    private final Pose startPose = new Pose(65, 135.7, Math.toRadians(180)); // Start Pose of our robotprivate Path scorePreload;
    ...
    private PathChain grabPickup1, scorePickup1, grabPickup2, scorePickup2, grabPickup3, scorePickup3, curvedLineBlue;
    ...
    {
        opmodeTimer.resetTimer();
        follower.followPath(curvedLineBlue);
    }
